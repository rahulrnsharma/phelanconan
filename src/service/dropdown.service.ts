...
export class DropdownService {
    ...
    async getInstitute(queryDto: TimezoneDto) {
        ...
        let query: PipelineStage[] = [UtilityService.getMatchPipeline({ date: { $gte: _date } })];
    ...
    async getDate(queryDto: SearchDateDto) {
        let _date = UtilityService.setStartHour(new Date(), queryDto.timezone);
        let query: PipelineStage[] = [UtilityService.getMatchPipeline({ date: { $gte: _date }, institute: new Types.ObjectId(queryDto.institute) })];
    ...
    async getTime(queryDto: SearchTimeDto) {
        let query: PipelineStage[] = [UtilityService.getMatchPipeline({ date: queryDto.date, institute: new Types.ObjectId(queryDto.institute) })];
    ...
    async getFaculty(queryDto: SearchFacultyDto) {
        let query: PipelineStage[] = [UtilityService.getMatchPipeline({ date: queryDto.date, time: queryDto.time, institute: new Types.ObjectId(queryDto.institute) })];
    ...
    async getCourse(queryDto: SearchCourseDto) {
        let query: PipelineStage[] = [UtilityService.getMatchPipeline({ date: queryDto.date, time: queryDto.time, institute: new Types.ObjectId(queryDto.institute), faculty: new Types.ObjectId(queryDto.faculty) })];
